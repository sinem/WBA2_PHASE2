...
public class gui_prof {
	...
	gui_prof() {
        ...
        String interessen[] = {"Prof. E. Ehses", "Prof. F. Victor", "Prof. B. Bertelsmeier", "Prof. C. Noss", "Prof. M. Winter", "Prof. H. L. Stahl", "Prof. H. Stenzel", "Prof. H. Kornacher"};
